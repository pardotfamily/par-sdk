...
export const ADDRESSES = {
  ...
  floorVault: "0xA5e805856e513F01d6aC992aC45FE54E5e601829" as Address,
  ...
  disperse: "0x28a5f3F898E99753E322fdce6EFa8b294C215B9b" as Address,
  // The first disperser: token-only payouts, before September 2026.
  disperseV1: "0xF09E4997Ca8aC5869de8B1C63acc4a3180c087EC" as Address,
...
export type ParAddresses = { readonly [K in keyof typeof ADDRESSES]: Address };
 ...
 */
export const ADDRESSES_ARC: ParAddresses = {
 ...
 */
export const ADDRESSES_ARC_TESTNET: ParAddresses = {
  factory: "0x02E9EE8527f4AFF58f7a1E08B1b898637ce718e9",
  router: "0xE721a861b32dEc68230101EA576304a63ebeEacd",
  locker: "0xE5B0B35F4927004fE8c0E437030723Eb80F6C32E",
  multiFactory: "0x920Ca489f8c9573645b8aB00dad60fc81c9487fd",
...
export const ADDRESSES_BASE: ParAddresses = {
  ...EVM_PAR,
 ...
 */
export const ADDRESSES_BNB: ParAddresses = {
  ...EVM_PAR,
...
export const ADDRESSES_BY_CHAIN: Record<number, ParAddresses> = {
...
export function getAddresses(chainId: number = ROBINHOOD_CHAIN_ID): ParAddresses {
  const a = ADDRESSES_BY_CHAIN[chainId];
  if (!a) throw new Error(`par is not deployed on chain ${chainId}`);
  return a;
}
...
export const UNISWAP_BY_CHAIN: Record<number, UniswapAddresses> = {
  [ROBINHOOD_CHAIN_ID]: {
    poolManager: "0x8366a39CC670B4001A1121B8F6A443A643e40951",
...
export const DEPLOY_BLOCK_BY_CHAIN: Record<number, bigint> = {
...
export function deployBlockOf(chainId: number = ROBINHOOD_CHAIN_ID): bigint {
 ...
 */
export const HOSTS_BY_CHAIN: Record<number, { app: string; indexer: string }> = {
...
export function indexerUrlOf(chainId: number = ROBINHOOD_CHAIN_ID): string {
